    ...
    <>
      ...
      >
        <Navbar.Toggle
          ...
          className=" text-danger border-danger ms-3"
        />
      ...
      >
        ...
        >
          <div role="button" className="random-track">
            <i className="fas fa-random fs-6"></i>
          </div>
          <div role="button" className="prev-track">
            <i className="fa fa-step-backward fs-6"></i>
          </div>
          <div role="button" className="playpause-track ">
            <i className="fa fa-play fs-5"></i>
          </div>
          <div role="button" className="next-track">
            <i className="fa fa-step-forward fs-6"></i>
          </div>
          <div role="button" className="repeat-track ">
            <i className="fas fa-sync fs-6"></i>
          </div>
        </Col>
        <Col className="d-flex" lg={4}>
          <Button
            className=" flex-grow-1 rounded-0 opacity-75"
            variant="secondary"
          >
            <img src={logo} alt="Apple logo" className="mb-2" />
          </Button>
        ...
        <Col lg={2} className="d-flex justify-content-center">
          <Button className="mx-2 py-1 px-2 " variant="danger">
